...
#### In the **INFO498f** class, there are **`r info_list$rows`** students. The class is composed of: 
...
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
# Builds first chart
chart_data <- info_list$r_exp_by_standing
scale_name <- info_list$equivalent$scale3
